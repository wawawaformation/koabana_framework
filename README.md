...
| `SMTP_SECURE` | — | Chiffrement SMTP (tls, ssl) |
| `SMTP_AUTO_TLS` | `1` | Negociation TLS automatique |
...
- **[Contrôleurs](src/Controller/README.md)** — Classe AbstractController, methodes courantes, sessions
- **[Formulaires](src/Form/README.md)** — Création, validation, hydration d'entités, rendu HTML
- **[Vues](src/View/README.md)** — Rendu templates, layouts, sections, CSS/JS, SVG inline
- **[Mailing](src/Mail/README.md)** — Envoi emails avec PHPMailer, configuration SMTP, exemples
